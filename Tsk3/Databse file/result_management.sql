...
(36, 'Shanaya Singh', 1, '1 A'),
(37, 'Rupali thakur', 2, '1 B'),
(38, 'Preeti kapur', 3, '1 C'),
(39, 'Tina Raut', 4, '2 A'),
(40, 'Shreeja shetty', 5, '2 B'),
(41, 'Karina Kumari', 6, '2 C'),
(42, 'Ramsha patel', 7, '3 A'),
(43, 'Aditya Sharma', 8, '3 B'),
(44, 'Anurag Singhania', 9, '3 C'),
(45, 'Shruti Shah', 10, '4 A'),
(46, 'Mahek Patel', 11, '4 B'),
(47, 'Ranbir Kapoor', 12, '4 C'),
(48, 'Aditi Rathore', 13, '5 A'),
(49, 'Krusha pandav', 14, '5 B'),
(51, 'Jay jain', 15, '5 C'),
(52, 'Priya singh', 16, '6 A'),
(53, 'harshita singh', 17, '6 A'),
(54, 'Darshana Chotaliya', 18, '12 C'),
(55, 'Siddhi Patel', 19, '2 A'),
(56, 'Saloni Fernandes', 20, '11 B'),
(57, 'Meera Rane', 21, '11 B');
...
--
ALTER TABLE `students`
  MODIFY `Sno` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
COMMIT;
